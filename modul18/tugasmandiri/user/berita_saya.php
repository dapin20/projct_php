...
$query = "SELECT * FROM berita WHERE user_id = " . $_SESSION['user_id'] . " ORDER BY created_at DESC";
...
<head>
    ...
    <title>Berita Saya - Aplikasi Berita</title>
        ...
        <div class="row">
            ...
            <main class="col-md-10 main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><i class="fas fa-pen-fancy"></i> Berita Saya</h1>
                ...
                <div class="table-container">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        <div class="empty-state">
                            ...
                            <p>Anda belum membuat berita apapun. Mulai buat berita sekarang!</p>
                            <a href="berita_tambah.php" class="btn btn-primary mt-3">
