...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Cek username sudah ada (tapi bukan username user ini)
    $check = mysqli_query($koneksi, "SELECT * FROM users WHERE username = '$username' AND id != $id");
    if (mysqli_num_rows($check) > 0) {
        $error = "Username sudah terdaftar!";
    } else {
        $query = "UPDATE users SET username = '$username', email = '$email', level = '$level' $password_part WHERE id = $id";
...
<head>
    ...
    <title>Edit User - Aplikasi Berita</title>
