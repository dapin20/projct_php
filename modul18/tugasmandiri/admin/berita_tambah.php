...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$error) {
        $foto_part = $foto ? ", '$foto'" : ", NULL";
        $query = "INSERT INTO berita (judul, isi, foto, user_id) VALUES ('$judul', '$isi' $foto_part, $user_id)";
        if (mysqli_query($koneksi, $query)) {
            $success = "Berita berhasil ditambahkan!";
            header("Refresh: 2; url=berita_list.php");
        } else {
...
<head>
    ...
    <title>Tambah Berita - Aplikasi Berita</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-10 main-content">
                ...
                <h1 class="mb-4"><i class="fas fa-plus-circle"></i> Tambah Berita</h1>
                ...
                <div class="form-card">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="isi" name="isi" rows="10" required placeholder="Masukkan isi berita"></textarea>
                        </div>

                        <button type="submit" class="btn btn-submit text-white">
                            <i class="fas fa-save"></i> Tambah Berita
                        </button>
                    </form>
                </div>
            </main>
